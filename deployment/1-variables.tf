...
variable "vpc_availability_zones" {
  ...
  type        = list(string)
  default     = ["ap-south-1a", "ap-south-1b"] # Two availability zones for your specific region
}
...
variable "dev_api_server_domain" {
  ...
  type        = string
  default     = "api.dev.snsappserver.xyz"
}

variable "ec2_iam_role_name" {
  description = "EC2 IAM Role Name"
  type        = string
  default     = "sns-app-server-ec2-role" # Add a unique name
}

variable "ec2_iam_role_policy_name" {
  description = "EC2 IAM Role Policy Name"
  type        = string
  default     = "sns-app-server-ec2-policy" # Add a unique name
}

variable "ec2_instance_profile_name" {
  description = "EC2 Instance Profile Name"
  type        = string
  default     = "sns-app-server-ec2-profile" # Add a unique name
}
...
variable "code_deploy_role_name" {
  ...
  type        = string
  default     = "sns-app-codedeploy-role" # Add a unique name
}

variable "prefix" {
  description = "Prefix to be added to AWS resources tags"
  type        = string
  default     = "snsapp-server" # Add a unique identifier name
}

variable "project" {
  description = "Prefix to be added to AWS resources local tags"
  type        = string
  default     = "snsapp-server" # You can use the name unique identifier created above
}
