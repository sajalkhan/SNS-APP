...
import * as cloudinaryUploads from '@global/helpers/coludinary-upload';
...
jest.mock('@global/helpers/coludinary-upload');
...
describe('SignUp', () => {
  ...
  //TODO: follow signUp Schema to write test cases
